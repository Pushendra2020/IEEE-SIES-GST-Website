...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: IEEE1, text: "Bridge" },
      { image: IEEE2, text: "Desk Setup" },
      { image:IEEE3, text: "Waterfall" },
      { image: IEEE4, text: "Strawberries" },
      { image: IEEE5, text: "Deep Diving" },
      { image: IEEE6, text: "Train Track" },
